...
<h1 align="center" style="margin: 30px 0 30px; font-weight: bold;">学科竞赛管理系统</h1>
<h4 align="center">基于SpringBoot+Vue前后端分离的竞赛信息管理平台</h4>
<p align="center">
...
## 平台简介
学科竞赛管理系统是一套全部开源的竞赛信息管理平台，为高校学科竞赛管理提供全方位支持。
