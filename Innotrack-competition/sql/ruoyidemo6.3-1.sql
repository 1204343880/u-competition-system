...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '竞赛队伍表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of comp_team
-- ----------------------------
INSERT INTO `comp_team` VALUES (1, 202, '一切可以队', 3, 'student01', 'N7VZBU', '0', 5, 1, '2', 'student01', '2026-06-03 14:37:38', '', '2026-06-03 14:46:43', NULL, '0', NULL);
INSERT INTO `comp_team` VALUES (2, 202, 'ok队', 100, 'yao', '8SYFQ6', '0', 5, 2, '0', 'student01', '2026-06-03 14:52:15', 'yao', '2026-06-03 14:57:00', NULL, '0', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '队伍队员关联表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '竞赛报名表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of competition_apply
-- ----------------------------
INSERT INTO `competition_apply` VALUES (1, 100, 3, 'student01', '李四同学', '创新团队', '李四同学,张三同学,王五同学', '2026-05-29 16:02:16', '1', NULL, '', '2', '', NULL, '', '2026-06-03 13:09:02');
INSERT INTO `competition_apply` VALUES (2, 100, 5, 'student02', '赵同学', '智慧队', '赵同学,钱同学,孙同学', '2026-05-29 16:02:16', '0', NULL, '', '0', '', NULL, '', NULL);
INSERT INTO `competition_apply` VALUES (3, 101, 3, 'student01', '李四同学', '代码先锋队', '李四同学', '2026-05-29 16:02:16', '1', NULL, '', '2', '', NULL, '', '2026-06-03 13:09:04');
INSERT INTO `competition_apply` VALUES (4, 201, 3, 'student01', 'yu', '', '', '2026-06-02 22:01:48', '0', NULL, '', '2', 'student01', '2026-06-02 22:01:48', '', '2026-06-03 13:09:13');
INSERT INTO `competition_apply` VALUES (5, 201, 3, 'student01', 'yu', '', '', '2026-06-03 13:09:20', '0', NULL, '', '0', 'student01', '2026-06-03 13:09:20', '', NULL);
INSERT INTO `competition_apply` VALUES (6, 200, 3, 'student01', 'yu', '', '', '2026-06-03 13:50:37', '0', NULL, '', '0', 'student01', '2026-06-03 13:50:37', '', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 3051 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单权限表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_menu` VALUES (3040, '组队广场', 3000, 2, 'team-square', 'student/hall/team-square', '', 'StudentTeamSquare', 1, 0, 'C', '0', '0', 'student:team:square:list', 'peoples', 'admin', '2026-06-03 15:15:21', '', NULL, '组队广场-公开招募队伍列表');
INSERT INTO `sys_menu` VALUES (3050, '人才市场', 3000, 3, 'market', 'student/hall/market', '', 'StudentMarket', 1, 0, 'C', '0', '0', 'student:market:list', 'people', 'admin', '2026-06-03 15:15:21', '', NULL, '人才市场-学生技能展示');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, NULL, 'admin', 'admin', '00', 'admin@tlxy.edu.cn', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-06-03 14:47:58', '2026-05-29 16:02:15', NULL, NULL, NULL, 'admin', '2026-05-29 16:02:15', '', NULL, '超级管理员', '0');
INSERT INTO `sys_user` VALUES (2, 101, 'teacher01', '张老师', '00', 'teacher01@tlxy.edu.cn', '15666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-05-29 16:02:15', '2026-05-29 16:02:15', NULL, NULL, NULL, 'admin', '2026-05-29 16:02:15', '', NULL, '计算机学院老师', '0');
INSERT INTO `sys_user` VALUES (3, 101, 'student01', 'yu', '00', 'student01@tlxy.edu.cn', '15777777777', '1', '/profile/avatar/2026/06/01/4cb4bfdb2cc34d889015cad4290a957e.jpg', '$2a$10$7Twf9K.Ww7iS/f1HT2B7busjKcnMSgUqQJ/.2ZeASHOhLqnxZ.LGy', '0', '0', '127.0.0.1', '2026-06-03 15:31:58', '2026-05-31 14:56:18', '2206161033', '2022级', '路演答辩,PPT美工,UI/UX设计,项目PM,市场调研', 'admin', '2026-05-29 16:02:15', 'admin', '2026-06-03 15:46:17', '计算机学院学生', '1');
...
INSERT INTO `sys_user` VALUES (100, 902, 'yao', 'yao', '00', '11111111111@qq.com', '15811111111', '1', '', '$2a$10$zRh8CDS5rbE9t24ED/1yn.vW4MyPIwlQDzzlae8uBIbsWwlu3h0JC', '0', '0', '127.0.0.1', '2026-06-03 14:55:30', NULL, NULL, NULL, NULL, 'admin', '2026-06-03 14:49:31', '', NULL, 'wu', '0');
