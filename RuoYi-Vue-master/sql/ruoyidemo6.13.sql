...
) ENGINE = InnoDB AUTO_INCREMENT = 228 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统访问记录' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '公告已读记录表' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, NULL, 'admin', 'admin', '00', 'admin@tlxy.edu.cn', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-06-11 15:54:02', '2026-05-29 16:02:15', NULL, NULL, NULL, 'admin', '2026-05-29 16:02:15', '', NULL, '超级管理员', '0');
...
INSERT INTO `sys_user` VALUES (100, NULL, 'yao', 'yao', '00', '11111111111@qq.com', '15811111111', '1', '', '$2a$10$zRh8CDS5rbE9t24ED/1yn.vW4MyPIwlQDzzlae8uBIbsWwlu3h0JC', '0', '0', '127.0.0.1', '2026-06-07 20:39:47', NULL, NULL, NULL, '路演答辩,UI/UX设计,海报/视频剪辑,财务测算,BP撰写', 'admin', '2026-06-03 14:49:31', '', '2026-06-03 21:40:03', 'wu', '1');
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '教师邀请表' ROW_FORMAT = DYNAMIC;
