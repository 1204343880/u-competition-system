...
INSERT INTO `sys_menu` VALUES (3000, '竞赛大厅', 0, 1, 'hall', NULL, '', '', 1, 0, 'M', '0', '0', '', 'star', 'admin', '2026-05-31 15:41:34', '', NULL, '参赛学生竞赛大厅目录');
INSERT INTO `sys_menu` VALUES (3001, '竞赛列表', 3000, 1, 'list', 'student/hall/index', '', 'StudentHall', 1, 0, 'C', '0', '0', 'student:hall:list', 'list', 'admin', '2026-05-31 15:41:34', '', NULL, '竞赛大厅-竞赛列表页面');
INSERT INTO `sys_menu` VALUES (3002, '竞赛查询', 3001, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'student:hall:query', '#', 'admin', '2026-05-31 15:41:34', '', NULL, '');
INSERT INTO `sys_menu` VALUES (3010, '组队匹配中心', 0, 2, 'match', NULL, '', '', 1, 0, 'M', '0', '0', '', 'peoples', 'admin', '2026-05-31 15:41:34', '', NULL, '参赛学生组队匹配目录');
INSERT INTO `sys_menu` VALUES (3011, '匹配大厅', 3010, 1, 'index', 'student/match/index', '', 'StudentMatch', 1, 0, 'C', '0', '0', 'student:match:list', 'search', 'admin', '2026-05-31 15:41:34', '', NULL, '组队匹配-匹配大厅页面');
INSERT INTO `sys_menu` VALUES (3012, '匹配查询', 3011, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'student:match:query', '#', 'admin', '2026-05-31 15:41:34', '', NULL, '');
INSERT INTO `sys_menu` VALUES (3013, '创建队伍', 3011, 2, '', '', '', '', 1, 0, 'F', '0', '0', 'student:match:create', '#', 'admin', '2026-05-31 15:41:34', '', NULL, '');
INSERT INTO `sys_menu` VALUES (3020, '薪火相传', 0, 3, 'knowledge', NULL, '', '', 1, 0, 'M', '0', '0', '', 'education', 'admin', '2026-05-31 15:41:34', '', NULL, '参赛学生知识库目录');
INSERT INTO `sys_menu` VALUES (3021, '知识库', 3020, 1, 'index', 'student/knowledge/index', '', 'StudentKnowledge', 1, 0, 'C', '0', '0', 'student:knowledge:list', 'documentation', 'admin', '2026-05-31 15:41:34', '', NULL, '薪火相传-知识库页面');
INSERT INTO `sys_menu` VALUES (3022, '知识库查询', 3021, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'student:knowledge:query', '#', 'admin', '2026-05-31 15:41:34', '', NULL, '');
INSERT INTO `sys_menu` VALUES (3030, '我的赛程', 0, 4, 'myrace', NULL, '', '', 1, 0, 'M', '0', '0', '', 'time-range', 'admin', '2026-05-31 15:41:34', '', NULL, '参赛学生我的赛程目录');
INSERT INTO `sys_menu` VALUES (3031, '我的竞赛', 3030, 1, 'race', 'student/race/index', '', 'StudentRace', 1, 0, 'C', '0', '0', 'student:race:list', 'chart', 'admin', '2026-05-31 15:41:34', '', NULL, '我的赛程-我的竞赛页面');
INSERT INTO `sys_menu` VALUES (3032, '赛程查询', 3031, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'student:race:query', '#', 'admin', '2026-05-31 15:41:34', '', NULL, '');
INSERT INTO `sys_menu` VALUES (3033, '上传凭证', 3031, 2, '', '', '', '', 1, 0, 'F', '0', '0', 'student:race:upload', '#', 'admin', '2026-05-31 15:41:34', '', NULL, '');
INSERT INTO `sys_menu` VALUES (3034, '我的信息', 3030, 2, 'profile', 'student/profile/index', '', 'StudentProfile', 1, 0, 'C', '0', '0', 'student:profile:list', 'user', 'admin', '2026-05-31 15:41:34', '', NULL, '我的赛程-个人信息页面');
INSERT INTO `sys_menu` VALUES (3035, '信息查询', 3034, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'student:profile:query', '#', 'admin', '2026-05-31 15:41:34', '', NULL, '');
INSERT INTO `sys_menu` VALUES (3036, '信息修改', 3034, 2, '', '', '', '', 1, 0, 'F', '0', '0', 'student:profile:edit', '#', 'admin', '2026-05-31 15:41:34', '', NULL, '');
...
INSERT INTO `sys_role` VALUES (2, '指导教师', 'teacher', 2, '2', 1, 1, '0', '0', 'admin', '2026-05-29 16:02:15', '', NULL, '指导教师');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, NULL, 'admin', 'admin', '00', 'admin@tlxy.edu.cn', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-05-31 14:55:05', '2026-05-29 16:02:15', 'admin', '2026-05-29 16:02:15', '', NULL, '超级管理员');
...
INSERT INTO `sys_user` VALUES (3, 101, 'student01', 'yu', '00', 'student01@tlxy.edu.cn', '15777777777', '1', '', '$2a$10$7Twf9K.Ww7iS/f1HT2B7busjKcnMSgUqQJ/.2ZeASHOhLqnxZ.LGy', '0', '0', '127.0.0.1', '2026-05-31 15:39:31', '2026-05-31 14:56:18', 'admin', '2026-05-29 16:02:15', 'admin', '2026-05-31 14:56:18', '计算机学院学生');
